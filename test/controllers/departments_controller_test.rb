...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { address: @department.address, name: @department.name, revenue: @department.revenue } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { address: @department.address, name: @department.name, revenue: @department.revenue } }
